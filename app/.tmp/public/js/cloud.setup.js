...
Cloud.setup({
  ...
  methods: {
    ...
    { 
      ...
      "args": ["correo", "password", "rememberMe"] 
    },
    ...
    { 
      ...
      "args": ["correo", "password", "nombre", "nit"] 
    },
    ...
    { 
      ...
      "args": ["correo", "topic", "nombre", "message"] 
    },

    "uploadfiles": 
    { 
      "verb": "POST", 
      "url": "/api/v1/documentation/uploadfiles", 
    ...
    { 
      "verb": "POST", 
      "url": "/api/v1/management/activate-account", 
      "args": ["nit","activado"] 
    }
